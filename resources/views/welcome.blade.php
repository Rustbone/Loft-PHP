                        ...
                        <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                            ...
                            >
                                ...
                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black dark:text-white">Laracasts Rust</h2>
    ...
    <div class="content-main__container">
      <div class="products-columns">
        <div class="products-columns__item">
          ...
          <div class="products-columns__item__description"><span class="products-price">401 руб</span><a href="#" class="btn btn-blue">Купить</a></div>
        </div>
        <div class="products-columns__item">
